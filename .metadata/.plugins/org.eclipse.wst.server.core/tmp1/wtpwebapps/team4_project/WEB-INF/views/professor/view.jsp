...
<script> 
	...
	function videoChange(a,b,c,d){
		...
		//동영상 링크
		window.location.href='<%=request.getContextPath() %>/professor/video/view?lecture_data_no='+lecture_data_no+'&lecture_lastview_time='+lecture_lastview_time+'&lecture_no='+lecture_no+'&member_id='+member_id+'&lecture_lastview_time='+professor_id;		
	 }
