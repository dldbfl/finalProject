      ...
      <c:forEach items="${lectureDataList}" var="lecture" >
        <div class="item  col-xs-4 col-lg-4">
            <div class="thumbnail">
                ...
                <div class="caption">    
                	<c:if test="${lecture.lecture_data_favorites eq 1}">
	                	<div style="height: 50px">
		                	<label for="isimp" id="starlabel"><img id="star" src="/resources/images/star.png"></label>   
							<input type="checkbox" id="isimp" checked="checked">
						</div>
					</c:if>
					<c:if test="${lecture.lecture_data_favorites eq 0}">
	                	<div style="height: 50px">
		                	<label for="isimp" id="starlabel"><img id="star" src="/resources/images/star2.png"></label>   
							<input type="checkbox" id="isimp">
						</div>
					</c:if>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6" align="right">
                            <a class="btn btn-success" onclick="OpenWindow('/lecture/video/view?lecture_data_no=${lecture.lecture_data_no }&lecture_lastview_time=${lecture.lecture_lastview_time }&lecture_no=${lecture_no}&member_id=${member_id}&professor_id=${lecture.professor_id}','','1450','750');">영상 보기</a>
						</div>
                    </div>
