    ...
    <section id="section-timesheet" style="background-color: white; width: 100%;">
	 <div class="clearfix">
      ...
      <div class="clearfix" style="width: 100%; background-color: white; border-top: 2px solid steelblue; height: 500px;">
        ...
        <form enctype="multipart/form-data" name="regist" method="post" action="/board/qna/regist" >
         	<div class="titls">
           <label class="col-xs-offset-1 col-xs-1" >제목</label>
           	<input class="col-xs-2" id="title" name="qna_title" type="text" placeholder="제목을 입력하세요" required style="margin-left: 3%; width: 675px; " >
			</div>
			<div class="writerPwd">
	  	       <div class="col-xs-offset-1 col-xs-4 writerText">
		  	       <label style="float: left; margin-left: 1%;">작성자</label>
		  	       <input class="col-xs-2" style="height: 30px; font-size: 15px; " id="qna_writer" name="qna_writer" type="text" value="${member.member_id }" readonly="readonly" required>
	  	       </div>
				 <div class="btn-group">
