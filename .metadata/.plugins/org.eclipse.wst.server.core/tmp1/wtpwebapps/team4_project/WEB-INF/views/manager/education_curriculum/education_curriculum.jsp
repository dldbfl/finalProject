...
<form role="form" id= "modifyform" name='modifyform' method=post enctype="multipart/form-data">
	<div class="col-sm-12">
		...
		<div>
			<textarea readonly style="display: none;" class="col-sm-12 enterprise_modifyset" name ="education_curriculum">${manager_board.education_curriculum}</textarea>               					  
		</div>
...
function Cansel_go(){
	...
	$('#picturePreView').css({'background-image':'url("<%=request.getContextPath()%>/manager/picture/education_curriculum/${manager_board.manager_board_no}"'});
