...
public class Chairman_introduceDAOImpl implements Chairman_introduceDAO{
	 ...
	 */
	@Override
	public Manager_boardVO selectManager_board_Chairman_introduce(int manager_board_no) throws SQLException {		
	...
	public void updateManager_board_chairman_introduce(Manager_boardVO manager_board) throws SQLException {
		sqlSession.update("manager_board-mapper.updateManager_board_chairman_introduce",manager_board);
