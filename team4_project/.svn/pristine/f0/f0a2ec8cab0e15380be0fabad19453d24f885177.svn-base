...
public class LectureRequest {
	...
	private MultipartFile picture;				// 이미지 파일
	private int lecture_price;					// 강의금액
	private String lecture_content;				// 
	private Date lecture_end;					// 강의 종료시간
	...
	public String toString() {
		return "LectureRequest [lecture_no=" + lecture_no + ", professor_id=" + professor_id + ", manager_id="
				+ manager_id + ", lecture_distinction=" + lecture_distinction + ", lecture_title=" + lecture_title
				...
				+ ", lecture_img=" + lecture_img + ", picture=" + picture + ", lecture_price=" + lecture_price
				+ ", lecture_content=" + lecture_content + ", lecture_end=" + lecture_end + "]";
	}

	public LectureRequest(int lecture_no, String professor_id, String manager_id, String lecture_distinction,
			String lecture_title, Date lecture_progress, Date lecture_recruit_date, Date lecture_recruit_status,
			int approval_code, String lecture_img, MultipartFile picture, int lecture_price,
	...
	public LectureVO toLectureVO() {
		LectureVO lecture = new LectureVO();
		
		lecture.setLecture_content(this.lecture_content);
		lecture.setLecture_distinction(this.lecture_distinction);
		lecture.setLecture_img(this.lecture_img);
		lecture.setLecture_no(this.lecture_no);
		lecture.setLecture_price(this.lecture_price);
		lecture.setLecture_progress(this.lecture_progress);
		lecture.setLecture_recruit_date(this.lecture_recruit_date);
		lecture.setLecture_recruit_status(this.lecture_recruit_status);
		lecture.setLecture_end(this.lecture_end);
		lecture.setLecture_title(this.lecture_title);
		lecture.setManager_id(this.manager_id);
		lecture.setProfessor_id(this.professor_id);
		lecture.setApproval_code(1);
