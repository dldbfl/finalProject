...
<body>
	...
	<div class="container">
		<div class="mail-box">
					<h3 style="margin-top: 20px;"><a href="<%=request.getContextPath()%>/myPage/professorMain" style="color:black;">마이페이지</a>><a id="head1" href="javascript:location.reload()" style="color:#308fe2;" >수신함</a>><a href="<%=request.getContextPath()%>/message/receiver/recycle_list" style="color:black;">수신함 휴지통</a></h3>
					<br/>
				...
				<div class="inbox-body">
					<div class="mail-option">
						<div class="chk-all">
							<form id="receiverSearch" method="post" action="receiver_list" >
								...
								<div class="btn-group">
									...
									<ul class="dropdown-menu">
										<li><a
											href="<%=request.getContextPath() %>/message/messenger_list" style="font-size:16px;">발신함</a></li>
										<li><a
											href="<%=request.getContextPath() %>/message/receiver/recycle_list" style="font-size:16px;">
												휴지통</a></li>
								...
								<a href="javascript:history.go(0)" class="btn mini tooltips">
									<i class=" fa fa-refresh" style="font-size:16px;">새로고침</i>
								</a>
								<!-- 모달로 작성창 띄우기 -->
								<a href="#write" class="btn mini tooltips"> <i
									class=" fa fa-send-o" style="font-size:16px;">쪽지 보내기</i>
								</a>
								<a href="#" onclick="receiver_allRecycle()" class="btn mini tooltips"> <i
								...
								<select id="searchType" name="searchType"
									...
									<span id="gridSearch" class="input-group-btn"
										...
										<button id=receiverSearchBtn class="btn sr-btn" type="button"
					...
					<c:forEach var="receiver" items="${receiver }">
						...
						<table class="table table-inbox">
							...
							<tr>
								<td style="text-align:center; width:7%; padding: 20px 0px 0px 20px;"
									...
									<input type="checkbox" id="receiver_checked"
								...
								<td style="text-align: left; width: 45%;"><a style="color: black;" href="#detail" onclick="receiver_Detail(${receiver.receiver_no})">${receiver.receiver_title }</a></td>
								...
								<td class="recycle"
									...
									onclick="receiver_recycle('${receiver.receiver_no }');"><i
	...
	<div id="detail" class="overlay light">
	 ...
	 <nav aria-label="member list Navigation" class="col-xs-offset-5 col-xs-6" style="position: relative;">
...
function searchList_go(page,url){
	...
	if(url){
		...
		jobForm.attr("action","receiver_list")
	}
