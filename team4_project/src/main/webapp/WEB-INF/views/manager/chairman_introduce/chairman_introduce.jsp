...
div#picturePreView{
    ...
    width: 930px;
    margin-top: 40px;
    background-image: url(/manager/picture/chairman_introduce/4);
...
<form role="form" id= "modifyform" name='modifyform' method=post enctype="multipart/form-data">
	 <div class="col-sm-12">
 	 ...
 	 <div>  
	 	<textarea  style="display: none;"  readonly class="col-sm-12 enterprise_modifyset" name ="chairman_introduce">${manager_board.chairman_introduce}</textarea>
	 </div>
...
function Cansel_go(){
	...
	$('#picturePreView').css({'background-image':'url("<%=request.getContextPath()%>/manager/picture/chairman_introduce/${manager_board.manager_board_no}"'});
